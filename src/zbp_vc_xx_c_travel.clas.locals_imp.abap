CLASS lhc_ZVC_XX_C_Travel DEFINITION INHERITING FROM cl_abap_behavior_handler.
  PRIVATE SECTION.

    TYPES: tt_travel_failed   TYPE TABLE FOR FAILED zvc_xx_c_travel,
           tt_travel_reported TYPE TABLE FOR REPORTED zvc_xx_c_travel.
...
CLASS lhc_ZVC_XX_C_Travel IMPLEMENTATION.
      ...
      IF message-msgty = 'E' OR message-msgty = 'A'.
        APPEND VALUE #( %cid = cid
                        ...
                        %fail-cause = /dmo/cl_travel_auxiliary=>get_cause_from_message( msgid = message-msgid
                                                                                       msgno = message-msgno is_dependend = abap_false ) ) TO failed.
...
CLASS lsc_ZVC_XX_C_TRAVEL DEFINITION INHERITING FROM cl_abap_behavior_saver.
  PROTECTED SECTION.
...
CLASS lsc_zvc_xx_c_travel IMPLEMENTATION.
